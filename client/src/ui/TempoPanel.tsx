 ...
 * 低频面板,默认折叠以缩短左列;节拍器开关始终可见(演奏中常用)。
 */
...
export default function TempoPanel({
  ...
  const [open, setOpen] = useState(() => localStorage.getItem('orch.panel.tempo') === '1')
  useEffect(() => {
    localStorage.setItem('orch.panel.tempo', open ? '1' : '0')
  }, [open])
    ...
    <section className="panel">
      <h2 className="panel-title">
        <button
          ...
          data-testid="tempo-panel-toggle"
          aria-expanded={open}
